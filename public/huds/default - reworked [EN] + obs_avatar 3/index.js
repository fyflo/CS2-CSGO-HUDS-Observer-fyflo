...
const COLOR_T = 'rgba(240, 201, 65, 1.0)'
...
function updateScoreboard() {
	...
	if (teams.left.side == 'ct') {
		...
		$('#s_team2 #s_player1').css('background-color', 'rgba(240, 201, 65, 0.35)')
		$('#s_team2 #s_player3').css('background-color', 'rgba(240, 201, 65, 0.35)')
		$('#s_team2 #s_player5').css('background-color', 'rgba(240, 201, 65, 0.35)')
	} else {
		$('#s_team #s_player1').css('background-color', 'rgba(240, 201, 65, 0.35)')
		$('#s_team #s_player3').css('background-color', 'rgba(240, 201, 65, 0.35)')
		$('#s_team #s_player5').css('background-color', 'rgba(240, 201, 65, 0.35)')
...
function updateStatePaused(phase, type, previously) {
	...
	if (type == 'paused') {
		...
		$('#alert_middle #alert_text_middle #alert_text_middle_2')
			.text(
				teams.left.side == 't'
					? ' TIMEOUT: ' + '[' + teams.left.short_name.toUpperCase() + ']'
					: ' TIMEOUT: ' + '[' + teams.right.short_name.toUpperCase() + ']'
			)
			.css('color', COLOR_NEW_T)
		showAlertSlide(
			'#left_team',
